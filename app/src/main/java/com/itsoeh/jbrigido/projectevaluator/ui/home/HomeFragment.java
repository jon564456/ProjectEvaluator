            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (!respuesta.getBoolean("error")) {
                        ...
                        Toast.makeText(HomeFragment.this.getContext(), "Ocurrió un error", Toast.LENGTH_LONG).show();
                    }
                    totalAlumno.setText(res + "");  // Establecer el texto con el total de alumnos
                } catch (JSONException e) {
                    Toast.makeText(HomeFragment.this.getContext(), e.getMessage() + "", Toast.LENGTH_LONG).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(HomeFragment.this.getContext(), "Hubo un error" + error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
